...
namespace Contaminants_Monitoring.Models
{
    ...
    public partial class Governorate
    {
        ...
        public Governorate()
        {
            this.IndividualConsumptions = new HashSet<IndividualConsumption>();
            this.LabSamples = new HashSet<LabSample>();
        }
    
        public int pkGovernorateId { get; set; }
        public string GovernorateCode { get; set; }
        public string GovernorateName { get; set; }
    
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<IndividualConsumption> IndividualConsumptions { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
